...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/config')}}">网站配置项管理</a> &raquo; 添加网站配置项
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>类型：</th>
                        <td>
                            <input type="radio" name="field_type" value="text" onclick="onTr()" checked>text &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="field_type" value="textarea" onclick="onTr()">textarea &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="field_type" value="radio" onclick="onTr()">radio &nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
